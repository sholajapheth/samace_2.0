  ...
  return (
    <div>
      ...
      <div className="w-full mt-[2em]  ">
        ...
        <InputComp name="Hepatitis B&C" type="text" placeholder="Enter Hepatitis B&C" />
        <InputComp name="HIV" type="text" placeholder="Enter HIV" />
        <InputComp name="VDRL" type="text" placeholder="Enter VDRL" />
        <InputComp name="Malaria Parasite" type="text" placeholder="Enter Malaria Parasite" />
        <InputComp name="Blood Group" type="text" placeholder="Enter Blood Group" />
        <InputComp name="Genotype" type="text" placeholder="Enter Genotype" />
        <InputComp name="Blood Pressure" type="text" placeholder="Enter Blood Pressure" />
        <InputComp name="PCV" type="text" placeholder="Enter PCV" />
        <InputComp name="Cerebrospinal Meningitis" type="text" placeholder="Enter Cerebrospinal Meningitis" />
        <InputComp name="Hearing" type="text" placeholder="Enter Hearing" />
        <InputComp name="Urinalysis" type="text" placeholder="Enter Urinalysis" />
        <InputComp name="Chest X-ray" type="text" placeholder="Enter Chest X-ray" />
        <InputComp name="ENT" type="text" placeholder="Enter ENT" />
        <InputComp name="Alergies" type="text" placeholder="Enter Alergies" />
        <InputComp name="Sick Leave" type="text" placeholder="Enter Sick Leave" />
