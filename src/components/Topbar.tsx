    ...
    <div className="">
      <div className="flex items-center mb-[1em]  gap-4 px-[1.5em] w-full ">
        ...
        <div className="w-full flex md:flex-row flex-col items-center justify-between ">
          <span className="text-pri font-[700] lg:text-[20px] text-tm md:text-tl ">
            {topbar_value}
          </span>
          ...
          <div className="text-pri md:text-lg text-lm font-[700] ">
            ...
            <span className="md:inline hidden ">
              ...
              {location.pathname.includes("qa") &&
                " qualityassurance@sam-ace.com"}
              {location.pathname.includes("maintenance") &&
                "maintenance@sam-ace.com"}
              {location.pathname.includes("production") &&
                "production@sam-ace.com"}
            </span>
          </div>
        </div>
      </div>
      {show_topbar_actions && <SearchBarDemo />}
    </div>
  );
};
